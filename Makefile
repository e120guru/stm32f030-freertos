...
TARGET=freertos-blinky
CPU=-mcpu=cortex-m0
LDSCRIPT=STM32F030x8_FLASH.ld
...
FREERTOS_SRCS= \
	...
	external/FreeRTOS/portable/MemMang/heap_1.c \
...
AS_SRCS= \
	external/STM32CubeF0/Drivers/CMSIS/Device/ST/STM32F0xx/Source/Templates/gcc/startup_stm32f030x8.s
AS_INCLUDES=
...
LDFLAGS=$(MCU) -specs=nano.specs -T$(LDSCRIPT) $(LIBDIR) $(LIBS) -Wl,-Map=$(BUILDDIR)/$(TARGET).map,--cref -Wl,--gc-sections
...
.PHONY: all clean flash reset unlock